                 ...
                 #        box(title = "Need (M1) comparison", status = "info", width=12, 
                  #           collapsible = TRUE, collapsed = TRUE,
                   ...
                   #          p("The distribution and point estimate of the current
										#	         and updated M1 values are shown"),
                     #        br(),
                      #       p("Lower equals greater need")
                      #   ),
        ...
        #                     collapsible = TRUE, collapsed = TRUE,
         #                    
          #                   p("The distribution and point estimate of the current
					#						         and updated TBS"),
           #                  br(),
            #                 p("Higher equals greater benefit")
             #            ),
...
server <- function(input, output, session) {
  ...
  source(file.path("server", "server0_fn_comp_v2.R"),  local = TRUE)$value
  
  # TBS server ----
  source(file.path("server", "server1_1_v2.R"),  local = TRUE)$value
