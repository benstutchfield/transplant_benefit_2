      ...
      tabItem("tbs",# checkboxInput('showPanel1', 'Show panel', FALSE),
              ...
              fluidRow(
                ...
                column(3,
                      ...
                      box( title = "TBS version 1 (discontinued)", status = "warning", solidHeader = TRUE, addSpinner(  plotOutput("tbs_v1_base", height = 100), color = "#FF911C"), width = 12), 
                       
                      box(title = "TBS is based on the difference in 5 year predicted survival without transplant and after transplant.",  height = 70, width=12),

                      box(title = "5 year survival predictions", status = "warning",  collapsible = TRUE, collapsed = TRUE,  plotOutput("tbs_v1_predictions", height = 160), width = 12),

                      box(title = "Survival curve without Tx (Need)",  collapsible = TRUE, collapsed = TRUE, status  = "warning",  plotOutput("v1_m1_curve_base", height = 200), width = 12),
                      
                      infoBoxOutput("", width=12),
                    
                       box(title = "Survival curve after Tx (Utility)", collapsible = TRUE, collapsed = TRUE,  status  = "warning",  plotOutput("v1_m2_curve_base", height = 200), width = 12),
                ...
                column(3,
                   fluidRow(
                      ...
                      box(title = "The calculation uses area under the survival curves. Predicted 5 year survival and survival curves are shown below.",  height = 70, width=12),
                      
                     box(title = "5 year survival predictions", status = "primary",  collapsible = TRUE, collapsed = TRUE,  plotOutput("tbs_v2_predictions", height = 160), width = 12),

                        box(title = "Survival curve without Tx (Need)", status = "primary",  collapsible = TRUE, collapsed = TRUE, plotOutput("v2_m1_curve_base", height = 200), width = 12),

                       infoBoxOutput("", width=12),
                         
                        box(title = "Survival curve after Tx (Utility)", status = "primary",  collapsible = TRUE, collapsed = TRUE, plotOutput("v2_m2_curve_base", height = 200), width = 12),
