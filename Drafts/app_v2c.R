              ...
              fluidRow(
                ...
                column(3,
                      fluidRow(
                       ...
                       column(6, actionButton("add_graph_v1", "Click to add survival predictions")),
                       #   column(6, actionButton("reset_graph", "Reset Graphs")),
                       
                      box( withSpinner(plotOutput("v1_plots", height = 500)), width = 12),
               ...
               #        box(plotOutput("v1_m2_curve", height = 200), width = 12),
                ...
                column(3,
                   fluidRow(
                        ...
                        # column(6, actionButton("add_graph_v2", "Click to add survival predictions")),
                       #   column(6, actionButton("reset_graph", "Reset Graphs")),
                       
                      # box( withSpinner(plotOutput("v2_plots", height = 500)), width = 12),
                      
                       box(plotOutput("v1_m1_curve_base", height = 500), width = 12),
...
server <- function(input, output, session) {
  ...
  # TBS server ----
  source(file.path("server", "server1_1_v4.R"),  local = TRUE)$value
