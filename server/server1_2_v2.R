...
observeEvent(input$NAFLD_60_45, {
  # First panel
  updateRadioButtons(session, "rinpatient_tbs",
                     selected = 0)
  updateSelectInput(session, "rregistration_tbs", 
...
observeEvent(input$NAFLD_49_45, {
  # First panel
  updateRadioButtons(session, "rinpatient_tbs",
                     selected = 0)
  updateSelectInput(session, "rregistration_tbs", 
...
observeEvent(input$ca_size5_afp1000_45, {
  # First panel
  updateRadioButtons(session, "rinpatient_tbs",
                     selected = 0)
  updateSelectInput(session, "rregistration_tbs", 
...
observeEvent(input$NAFLD_60_65, {
  # First panel
  updateRadioButtons(session, "rinpatient_tbs",
                     selected = 0)
  updateSelectInput(session, "rregistration_tbs", 
...
observeEvent(input$NAFLD_49_65, {
  # First panel
  updateRadioButtons(session, "rinpatient_tbs",
                     selected = 0)
  updateSelectInput(session, "rregistration_tbs", 
...
observeEvent(input$ca_size5_afp1000_65, {
  # First panel
  updateRadioButtons(session, "rinpatient_tbs",
                     selected = 0)
  updateSelectInput(session, "rregistration_tbs", 
...
#additions
observeEvent(input$yrs3_wait, {
  # First panel
  updateSliderInput(session, "rwaiting_time_tbs",
                    value=input$rwaiting_time_tbs + 1095)
  updateSliderInput(session, "rage_tbs",
                    value=input$rage_tbs + 3)
})

observeEvent(input$small_cancer, {
  # First panel
  updateSelectInput(session, "rdisease_secondary_tbs", 
                    selected = 1)
...
observeEvent(input$large_cancer, {
  # First panel
  updateSelectInput(session, "rdisease_secondary_tbs", 
                    selected = 1)
...
observeEvent(input$outpatient, {
  updateRadioButtons(session, "rinpatient_tbs",
                     selected = 0)
  
})  

observeEvent(input$inpatient, {
  updateRadioButtons(session, "rinpatient_tbs",
                     selected = 1)
  
})  

observeEvent(input$max_cancer, {
  # First panel
  updateSelectInput(session, "rdisease_secondary_tbs", 
                    selected = 1)
...
observeEvent(input$remove_cancer, {
  # First panel
  updateSelectInput(session, "rdisease_secondary_tbs", 
                    selected = 9)
...
observeEvent(input$ascites_enceph, {
  updateRadioButtons(session, "rencephalopathy_tbs",
                     selected = 1)
  updateRadioButtons(session, "rascites_tbs",
                     selected = 1)
...
observeEvent(input$renal_replace, {
  updateRadioButtons(session, "rrenal_tbs",
                     selected = 1)
